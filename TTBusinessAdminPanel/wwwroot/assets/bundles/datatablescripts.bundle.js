!(function (a) {
    ...
    function j(c) {
        if (!Ua.__browser) {
            ...
            Ua.__browser = d;
            var e = a("<div/>")
                .css({ position: "fixed", top: 0, left: -1 * a(b).scrollLeft(), height: 1, width: 1, overflow: "hidden" })
                .append(
                    a("<div/>")
    ...
    function l(b, d) {
        var e = Ua.defaults.column,
            ...
            e = a.extend({}, Ua.models.oColumn, e, { nTh: d || c.createElement("th"), sTitle: e.sTitle ? e.sTitle : d ? d.innerHTML : "", aDataSort: e.aDataSort ? e.aDataSort : [f], mData: e.mData ? e.mData : f, idx: f });
    ...
    function m(b, c, e) {
        ...
        (c._bAttrSrc = a.isPlainObject(k) && (e(k.sort) || e(k.type) || e(k.filter))),
            ...
            c.bSortable && (b || e)
                ? b && !e
                    ? ((c.sSortingClass = g.sSortableAsc), (c.sSortingClassJUI = g.sSortJUIAscAllowed))
                    : !b && e
                        ? ((c.sSortingClass = g.sSortableDesc), (c.sSortingClassJUI = g.sSortJUIDescAllowed))
                        : ((c.sSortingClass = g.sSortable), (c.sSortingClassJUI = g.sSortJUI))
                : ((c.sSortingClass = g.sSortableNone), (c.sSortingClassJUI = ""));
    }
    function n(a) {
        ...
        if (c)
            for (g = c.length - 1; 0 <= g; g--) {
                ...
                for (a.isArray(o) || (o = [o]), h = 0, i = o.length; h < i; h++)
                    ...
                    else if ("string" == typeof o[h]) for (j = 0, k = n.length; j < k; j++) ("_all" == o[h] || a(n[j].nTh).hasClass(o[h])) && f(j, m);
            }
        if (e) for (g = 0, b = e.length; g < b; g++) f(g, e[g]);
    }
    function u(b, c, e, f) {
        var g = b.aoData.length,
            h = a.extend(!0, {}, Ua.models.oRow, { src: e ? "dom" : "data", idx: g });
            ...
            var c = function (b, e, f) {
                ...
                for (var h, i, j = 0, k = f.length - 1; j < k; j++) {
                    if (((h = f[j].match(kb)), (i = f[j].match(lb)), h)) {
                        if (((f[j] = f[j].replace(kb, "")), (b[f[j]] = []), (g = f.slice()), g.splice(0, j + 1), (h = g.join(".")), a.isArray(e))) for (i = 0, k = e.length; i < k; i++) (g = {}), c(g, e[i], h), b[f[j]].push(g);
                        else b[f[j]] = e;
                        return;
                    }
    ...
    function F(b, c, e, f) {
        var g,
            ...
            p = function (b) {
                (e !== d && e !== l) ||
                    ((h = m[l]), (i = a.trim(b.innerHTML)), h && h._bAttrSrc ? (A(h.mData._)(f, i), o(h.mData.sort, b), o(h.mData.type, b), o(h.mData.filter, b)) : n ? (h._setter || (h._setter = A(h.mData)), h._setter(f, i)) : (f[l] = i)),
                    l++;
            };
    ...
    function G(b, d, e, f) {
        var g,
            ...
            n = [];
        if (null === l.nTr) {
            for (g = e || c.createElement("tr"), l.nTr = g, l.anCells = n, g._DT_RowIndex = d, H(b, l), j = 0, k = b.aoColumns.length; j < k; j++)
                (i = b.aoColumns[j]),
                    (h = e ? f[j] : c.createElement(i.sCellType)),
                    (h._DT_CellIndex = { row: d, column: j }),
                    n.push(h),
                    (e && !i.mRender && i.mData === j) || (a.isPlainObject(i.mData) && i.mData._ === j + ".display") || (h.innerHTML = w(b, d, j, "display")),
                    i.sClass && (h.className += " " + i.sClass),
                    i.bVisible && !e ? g.appendChild(h) : !i.bVisible && e && h.parentNode.removeChild(h),
                    i.fnCreatedCell && i.fnCreatedCell.call(b.oInstance, h, w(b, d, j), m, d, j);
    ...
    function H(b, c) {
        ...
        if (d) {
            var f = b.rowIdFn(e);
            f && (d.id = f),
                e.DT_RowClass && ((f = e.DT_RowClass.split(" ")), (c.__rowc = c.__rowc ? ib(c.__rowc.concat(f)) : f), a(d).removeClass(c.__rowc.join(" ")).addClass(e.DT_RowClass)),
    ...
    function I(b) {
        ...
        for (j && (f = a("<tr/>").appendTo(h)), c = 0, d = l.length; c < d; c++)
            (g = l[c]),
                ...
                j && e.appendTo(f),
                b.oFeatures.bSort && (e.addClass(g.sSortingClass), !1 !== g.bSortable && (e.attr("tabindex", b.iTabIndex).attr("aria-controls", b.sTableId), ya(b, g.nTh, c))),
    ...
    function K(b) {
        ...
        if (-1 !== a.inArray(!1, c)) la(b, !1);
            ...
            if (0 !== k.length)
                ...
                (e = h.sZeroRecords),
                    1 == b.iDraw && "ajax" == Ma(b) ? (e = h.sLoadingRecords) : h.sEmptyTable && 0 === b.fnRecordsTotal() && (e = h.sEmptyTable),
                    (c[0] = a("<tr/>", { class: g ? f[0] : "" }).append(a("<td />", { valign: "top", colSpan: q(b), class: b.oClasses.sRowEmpty }).html(e))[0]);
        ...
        for (var g, h, i, j, k, l, m = b.sDom.split(""), n = 0; n < m.length; n++) {
            if (((g = null), "<" == (h = m[n]))) {
                if (((i = a("<div/>")[0]), "'" == (j = m[n + 1]) || '"' == j)) {
                    ...
                    "H" == k ? (k = c.sJUIHeader) : "F" == k && (k = c.sJUIFooter),
                        -1 != k.indexOf(".") ? ((j = k.split(".")), (i.id = j[0].substr(1, j[0].length - 1)), (i.className = j[1])) : "#" == k.charAt(0) ? (i.id = k.substr(1, k.length - 1)) : (i.className = k),
                        (n += l);
                }
                f.append(i), (f = a(i));
        ...
        for (f = 0, i = n.length; f < i; f++)
            for (d = n[f], e = d.firstChild; e;) {
                if ("TD" == e.nodeName.toUpperCase() || "TH" == e.nodeName.toUpperCase()) {
                    ...
                    for (j = g, m = 1 === k, h = 0; h < k; h++) for (g = 0; g < l; g++) (b[f + g][j + h] = { cell: e, unique: m }), (b[f + g].nTr = d);
                }
                e = e.nextSibling;
            }
    }
    ...
    function R(b) {
        ...
        var o = { draw: b.iDraw, columns: [], order: [], start: c, length: d, search: { value: j.sSearch, regex: j.bRegex } };
        for (c = 0; c < h; c++)
            (e = g[c]),
                (f = k[c]),
                (d = "function" == typeof e.mData ? "function" : e.mData),
                o.columns.push({ data: d, name: e.sName, searchable: e.bSearchable, orderable: e.bSortable, search: { value: f.sSearch, regex: f.bRegex } }),
                n("mDataProp_" + c, d),
                i.bFilter && (n("sSearch_" + c, f.sSearch), n("bRegex_" + c, f.bRegex), n("bSearchable_" + c, e.bSearchable)),
    ...
    function U(b) {
        var d = b.oClasses,
            ...
            h = function () {
                ...
                a != g.sSearch && (V(b, { sSearch: a, bRegex: g.bRegex, bSmart: g.bSmart, bCaseInsensitive: g.bCaseInsensitive }), (b._iDisplayStart = 0), K(b));
            },
            i = null !== b.searchDelay ? b.searchDelay : "ssp" === Ma(b) ? 400 : 0,
            k = a("input", d)
                .val(g.sSearch)
                .attr("placeholder", f.sSearchPlaceholder)
                .on("keyup.DT search.DT input.DT paste.DT cut.DT", i ? qb(h, i) : h)
    ...
    function V(a, b, c) {
        ...
        if ((s(a), "ssp" != Ma(a))) {
            for (Y(a, b.sSearch, c, b.bEscapeRegex !== d ? !b.bEscapeRegex : b.bRegex, b.bSmart, b.bCaseInsensitive), g(b), b = 0; b < f.length; b++)
                X(a, f[b].sSearch, b, f[b].bEscapeRegex !== d ? !f[b].bEscapeRegex : f[b].bRegex, f[b].bSmart, f[b].bCaseInsensitive);
            W(a);
        } else g(b);
        ...
        for (b = !1, c = 0, e = a.aoData.length; c < e; c++)
            if (((i = a.aoData[c]), !i._aFilterData)) {
                for (g = [], d = 0, f = j.length; d < f; d++)
                    (b = j[d]),
                        b.bSearchable ? ((h = w(a, c, d, "filter")), k[b.sType] && (h = k[b.sType](h)), null === h && (h = ""), "string" != typeof h && h.toString && (h = h.toString())) : (h = ""),
                        h.indexOf && -1 !== h.indexOf("&") && ((nb.innerHTML = h), (h = ob ? nb.textContent : nb.innerText)),
    ...
    function ba(b) {
        ...
        return d || (b.aoDrawCallback.push({ fn: ca, sName: "information" }), e.attr("role", "status").attr("aria-live", "polite"), a(b.nTable).attr("aria-describedby", c + "_info")), e[0];
    }
    function ca(b) {
    ...
    function ha(b) {
        for (
            var c = b.oClasses, d = b.sTableId, e = b.aLengthMenu, f = a.isArray(e[0]), g = f ? e[0] : e, e = f ? e[1] : e, f = a("<select/>", { name: d + "_length", "aria-controls": d, class: c.sLengthSelect }), h = 0, i = g.length;
            h < i;
            h++
        )
            f[0][h] = new Option("number" == typeof e[h] ? b.fnFormatNumber(e[h]) : e[h], g[h]);
    ...
    function ka(b) {
        return a("<div/>", { id: b.aanFeatures.r ? null : b.sTableId + "_processing", class: b.oClasses.sProcessing })
            ...
            (j = a("<div/>", { class: g.sScrollWrapper })
                .append(
                    a("<div/>", { class: g.sScrollHead })
                        .css({ overflow: "hidden", position: "relative", border: 0, width: e ? (e ? ta(e) : null) : "100%" })
                        .append(
                ...
                .append(
                    a("<div/>", { class: g.sScrollBody })
                        .css({ position: "relative", overflow: "auto", width: e ? ta(e) : null })
                        .append(c)
                )),
            l &&
            j.append(
                a("<div/>", { class: g.sScrollFoot })
                    .css({ overflow: "hidden", border: 0, width: e ? (e ? ta(e) : null) : "100%" })
                    .append(
        ...
        (e = q.scrollHeight > q.clientHeight),
            b.scrollBarVis !== e && b.scrollBarVis !== d
                ...
                : ((b.scrollBarVis = e),
                    ...
                    B && ((f = B.clone().prependTo(y)), (c = B.find("tr")), (f = f.find("tr"))),
                    ...
                    (m = y.outerWidth()),
                    "" === j
                        ? ((A.width = "100%"), D && (y.find("tbody").height() > q.offsetHeight || "scroll" == t.css("overflow-y")) && (A.width = ta(y.outerWidth() - i)), (m = y.outerWidth()))
                    ...
                    y.outerWidth() < m
                        ? ((c = q.scrollHeight > q.offsetHeight || "scroll" == t.css("overflow-y") ? m + i : m),
                            D && (q.scrollHeight > q.offsetHeight || "scroll" == t.css("overflow-y")) && (A.width = ta(c - i)),
                            ("" === j || "" !== k) && Ea(b, 1, "Possible column misalignment", 6))
                        : (c = "100%"),
                    (u.width = ta(c)),
                    (p.width = ta(c)),
                    ...
                    (r.width = ta(j)),
                    (k = y.height() > q.clientHeight || "scroll" == t.css("overflow-y")),
                    (l = "padding" + (C.bScrollbarLeft ? "Left" : "Right")),
                    (r[l] = k ? i + "px" : "0px"),
                    B && ((w[0].style.width = ta(j)), (v[0].style.width = ta(j)), (v[0].style[l] = k ? i + "px" : "0px")),
                    y.children("colgroup").insertBefore(y.children("thead")),
                    t.scroll(),
                    (!b.bSorted && !b.bFiltered) || b._drawHold || (q.scrollTop = 0));
    }
    function oa(a, b, c) {
    ...
    function pa(c) {
        ...
        if (h || (!u && !j && !i && l == q(c) && l == p.length)) for (d = 0; d < l; d++) null !== (m = o(c, d)) && (g[m].sWidth = ta(p.eq(d).width()));
        else {
            (l = a(f).clone().css("visibility", "hidden").removeAttr("id")), l.find("tbody tr").remove();
            var w = a("<tr/>").appendTo(l.find("tbody"));
            for (l.find("thead, tfoot").remove(), l.append(a(c.nTHead).clone()).append(a(c.nTFoot).clone()), l.find("tfoot th, tfoot td").css("width", ""), p = O(c, l.find("thead")[0]), d = 0; d < m.length; d++)
                (e = g[m[d]]),
                    (p[d].style.width = null !== e.sWidthOrig && "" !== e.sWidthOrig ? ta(e.sWidthOrig) : ""),
                    e.sWidthOrig && j && a(p[d]).append(a("<div/>").css({ width: e.sWidthOrig, margin: 0, padding: 0, border: 0, height: 1 }));
            ...
            for (
                ...
                e = a("<div/>")
                    .css(j || i ? { position: "absolute", top: 0, left: 0, height: 1, right: 0, overflow: "hidden" } : {})
                    .append(l)
                    .appendTo(t),
                j && k ? l.width(k) : j ? (l.css("width", "auto"), l.removeAttr("width"), l.width() < t.clientWidth && s && l.width(t.clientWidth)) : i ? l.width(t.clientWidth) : s && l.width(s),
                d = i = 0;
                d < m.length;
                d++
            )
                (t = a(p[d])), (k = t.outerWidth() - t.width()), (t = v.bBounding ? Math.ceil(p[d].getBoundingClientRect().width) : t.outerWidth()), (i += t), (g[m[d]].sWidth = ta(t - k));
    ...
    function ua(b) {
        ...
        for (
            ...
            for (i = l[b][0], f = k[i].aDataSort, c = 0, e = f.length; c < e; c++)
                (g = f[c]), (h = k[g].sType || "string"), l[b]._idx === d && (l[b]._idx = a.inArray(l[b][1], k[g].asSorting)), j.push({ src: i, col: g, dir: l[b][1], index: l[b]._idx, type: h, formatter: Ua.ext.type.order[h + "-pre"] });
        return j;
    }
    function va(a) {
        var b,
    ...
    function wa(a) {
        for (var b, c, d = a.aoColumns, e = ua(a), a = a.oLanguage.oAria, f = 0, g = d.length; f < g; f++) {
            ...
            i.removeAttribute("aria-sort"),
                c.bSortable &&
                (0 < e.length && e[0].col == f ? (i.setAttribute("aria-sort", "asc" == e[0].dir ? "ascending" : "descending"), (c = h[e[0].index + 1] || h[0])) : (c = h[0]), (b += "asc" === c ? a.sSortAscending : a.sSortDescending)),
        ...
        "number" == typeof g[0] && (g = b.aaSorting = [g]),
            e && b.oFeatures.bSortMulti
                ? ((e = a.inArray(c, eb(g, "0"))),
                    -1 !== e ? ((c = i(g[e], !0)), null === c && 1 === g.length && (c = 0), null === c ? g.splice(e, 1) : ((g[e][1] = h[c]), (g[e]._idx = c))) : (g.push([c, h[0], 0]), (g[g.length - 1]._idx = 0)))
                : g.length && g[0][0] == c
                    ? ((c = i(g[0])), (g.length = 1), (g[0][1] = h[c]), (g[0]._idx = c))
    ...
    function Aa(a, b) {
        ...
        for (var f, g = Ua.ext.type.order[d.sType + "-pre"], h = 0, i = a.aoData.length; h < i; h++)
            (d = a.aoData[h]), d._aSortData || (d._aSortData = []), (!d._aSortData[b] || e) && ((f = e ? c[h] : w(a, h, b, "sort")), (d._aSortData[b] = g ? g(f) : f));
    }
    function Ba(b) {
                    ...
                    if (-1 === a.inArray(!1, i) && !((0 < (i = b.iStateDuration) && c.time < +new Date() - 1e3 * i) || (c.columns && h.length !== c.columns.length))) {
                        if (
                            ((b.oLoadedState = a.extend(!0, {}, c)),
                                ...
                                c.search !== d && a.extend(b.oPreviousSearch, aa(c.search)),
                                c.columns)
                        )
        ...
        return (
            b <= c
                ...
                : a <= d
                    ...
                    : (a >= b - 1 - d ? (c = gb(b - (c - 2), b)) : ((c = gb(a - d + 2, a + d - 1)), c.push("ellipsis"), c.push(b - 1)), c.splice(0, 0, "ellipsis"), c.splice(0, 0, 0)),
            (c.DT_el = "span"),
            c
        );
    }
    ...
    var Qa,
            ...
            return (
                this.each(function () {
                    ...
                    if ("table" != this.nodeName.toLowerCase()) Ea(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                        ...
                        var B = a.extend(!0, {}, Ua.models.oSettings, { sDestroyWidth: w[0].style.width, sInstance: o, sTableId: o });
                        (B.nTable = this),
                            (B.oApi = c.internal),
                            (B.oInit = p),
                            x.push(B),
                            ...
                            (p = Ga(a.extend(!0, {}, s), p)),
                            Fa(B.oFeatures, p, "bPaginate bLengthChange bFilter bSort bSortMulti bInfo bProcessing bAutoWidth bSortClasses bServerSide bDeferRender".split(" ")),
                            Fa(B, p, [
                                "asStripeClasses",
                                "ajax",
                                "fnServerData",
                            ...
                            Ia(B, "aoStateSaveParams", p.fnStateSaveParams, "user"),
                            Ia(B, "aoStateLoadParams", p.fnStateLoadParams, "user"),
                            Ia(B, "aoStateLoaded", p.fnStateLoaded, "user"),
                            Ia(B, "aoRowCallback", p.fnRowCallback, "user"),
                            Ia(B, "aoRowCreatedCallback", p.fnCreatedRow, "user"),
                            Ia(B, "aoHeaderCallback", p.fnHeaderCallback, "user"),
                            Ia(B, "aoFooterCallback", p.fnFooterCallback, "user"),
                            Ia(B, "aoInitComplete", p.fnInitComplete, "user"),
                            Ia(B, "aoPreDrawCallback", p.fnPreDrawCallback, "user"),
                            (B.rowIdFn = z(p.rowId)),
                            j(B);
                        var C = B.oClasses;
                        a.extend(C, Ua.ext.classes, p.oClasses),
                            w.addClass(C.sTable),
                            B.iInitDisplayStart === d && ((B.iInitDisplayStart = p.iDisplayStart), (B._iDisplayStart = p.iDisplayStart)),
                            null !== p.iDeferLoading &&
                            ((B.bDeferLoading = !0), (o = a.isArray(p.iDeferLoading)), (B._iRecordsDisplay = o ? p.iDeferLoading[0] : p.iDeferLoading), (B._iRecordsTotal = o ? p.iDeferLoading[1] : p.iDeferLoading));
                        var D = B.oLanguage;
                        a.extend(!0, D, p.oLanguage),
                            ...
                            (a.ajax({
                                ...
                                (r = !0)),
                            null === p.asStripeClasses && (B.asStripeClasses = [C.sStripeOdd, C.sStripeEven]);
                            ...
                            a(E[0])
                                ...
                                .each(function (a, b) {
                                    ...
                                    if (c.mData === a) {
                                        ...
                                        (null === e && null === f) ||
                                            ((c.mData = { _: a + ".display", sort: null !== e ? a + ".@data-" + e : d, type: null !== e ? a + ".@data-" + e : d, filter: null !== f ? a + ".@data-" + f : d }), m(B, a));
                                    }
                                });
                        }
                        var G = B.oFeatures,
                            o = function () {
                                ...
                                if (
                                    (0 === c.length && (c = a("<thead/>").appendTo(w)),
                                        ...
                                        (B.nTBody = c[0]),
                                        (c = w.children("tfoot")),
                                        0 === c.length && b.length > 0 && ("" !== B.oScroll.sX || "" !== B.oScroll.sY) && (c = a("<tfoot/>").appendTo(w)),
                                        0 === c.length || 0 === c.children().length ? w.addClass(C.sNoFooter) : c.length > 0 && ((B.nTFoot = c[0]), N(B.aoFooter, B.nTFoot)),
                                        p.aaData)
                                )
        ...
        eb = function (a, b, c) {
            var e = [],
                f = 0,
                g = a.length;
            if (c !== d) for (; f < g; f++) a[f] && a[f][b] && e.push(a[f][b][c]);
    ...
    (Ra = function (b, c) {
        ...
        (this.context = ib(d)), c && a.merge(this, c), (this.selector = { rows: null, cols: null, opts: null }), Ra.extend(this, this, rb);
    }),
        (Ua.Api = Ra),
            ...
            iterator: function (a, b, c, e) {
                ...
                for ("string" == typeof a && ((e = c), (c = b), (b = a), (a = !1)), g = 0, h = n.length; g < h; g++) {
                    ...
                    if ("table" === b) (f = c.call(p, n[g], g)) !== d && m.push(f);
                        ...
                        for (l = this[g], "column-rows" === b && (k = yb(n[g], o.opts)), i = 0, j = l.length; i < j; i++)
                            (f = l[i]), (f = "cell" === b ? c.call(p, n[g], f.row, f.column, g, i) : c.call(p, n[g], f, g, i, k)) !== d && m.push(f);
                }
        ...
        (Ra.register = Sa = function (b, c) {
            if (a.isArray(b)) for (var d = 0, e = b.length; d < e; d++) Ra.register(b[d], c);
            else
                for (var f, g, h = b.split("."), i = rb, d = 0, e = h.length; d < e; d++) {
                    ...
                    j || ((j = { name: f, val: {}, methodExt: [], propExt: [] }), i.push(j)), d === e - 1 ? (j.val = c) : (i = g ? j.methodExt : j.propExt);
                }
        }),
        ...
        Sa("page.info()", function () {
            ...
            var a = this.context[0],
                ...
                f = -1 === c;
            return { page: f ? 0 : Math.floor(b / c), pages: f ? 1 : Math.ceil(e / c), start: b, end: a.fnDisplayEnd(), length: c, recordsTotal: a.fnRecordsTotal(), recordsDisplay: e, serverSide: "ssp" === Ma(a) };
        }),
    ...
    Sa("ajax.json()", function () {
        ...
        Sa("ajax.url()", function (b) {
            ...
            return b === d
                ? 0 === c.length
                    ? d
                    : ((c = c[0]), c.ajax ? (a.isPlainObject(c.ajax) ? c.ajax.url : c.ajax) : c.sAjaxSource)
    ...
    var vb = function (b, c, e, f, g) {
        ...
        wb = function (b) {
            return b || (b = {}), b.filter && b.search === d && (b.search = b.filter), a.extend({ search: "none", order: "current", page: "all" }, b);
        },
        xb = function (a) {
        ...
        yb = function (b, c) {
            ...
            if ("current" == f) for (d = b._iDisplayStart, e = b.fnDisplayEnd(); d < e; d++) g.push(h[d]);
                    ...
                    return vb(
                        ...
                        function (b) {
                            ...
                            if (((c = hb(fb(e.aoData, f, "nTr"))), b.nodeName))
                                return b._DT_RowIndex !== d ? [b._DT_RowIndex] : b._DT_CellIndex ? [b._DT_CellIndex.row] : ((c = a(b).closest("*[data-dt-row]")), c.length ? [c.data("dt-row")] : []);
    ...
    Sa("row().child()", function (b, c) {
        ...
        if (!0 === b) this.child.show();
            ...
            var f = e[0],
                ...
                g = [],
                h = function (b, c) {
                    if (a.isArray(b) || b instanceof a) for (var d = 0, e = b.length; d < e; d++) h(b[d], c);
    ...
    Sa("columns()", function (b, c) {
                        ...
                        function (b) {
                            ...
                            return b.nodeName && b._DT_CellIndex
                                ...
                                : ((c = a(i)
                                    ...
                                    .toArray()),
                                    c.length || !b.nodeName ? c : ((c = a(b).closest("*[data-dt-column]")), c.length ? [c.data("dt-column")] : []));
                        },
                        d,
                        f
                    );
                ...
                return this.iterator("table", function (c) {
                    ...
                    return vb(
                        ...
                        function (b) {
                            ...
                            if (null === b || b === d || e) {
                                for (g = [], h = 0, i = p.length; h < i; h++) for (f = p[h], j = 0; j < s; j++) (k = { row: f, column: j }), e ? ((l = o[f]), b(k, w(c, f, j), l.anCells ? l.anCells[j] : null) && g.push(k)) : g.push(k);
                                return g;
                            }
                            return a.isPlainObject(b)
                                ...
                                : ((e = r
                                    ...
                                    .toArray()),
                                    e.length || !b.nodeName ? e : ((l = a(b).closest("*[data-dt-row]")), l.length ? [{ row: l.data("dt-row"), column: l.data("dt-column") }] : []));
                        },
                        c,
                        n
                    );
        ...
        Sa("search()", function (b, c, e, f) {
            ...
            return b === d
                ...
                : this.iterator("table", function (d) {
                    d.oFeatures.bFilter && V(d, a.extend({}, d.oPreviousSearch, { sSearch: b + "", bRegex: null !== c && c, bSmart: null === e || e, bCaseInsensitive: null === f || f }), 1);
                });
        }),
        Ta("columns().search()", "column().search()", function (b, c, e, f) {
            return this.iterator("column", function (g, h) {
                ...
                g.oFeatures.bFilter && (a.extend(i[h], { sSearch: b + "", bRegex: null !== c && c, bSmart: null === e || e, bCaseInsensitive: null === f || f }), V(g, g.oPreviousSearch, 1));
            });
        }),
        Sa("state()", function () {
        ...
        (Ua.settings = []),
        (Ua.models = {}),
        (Ua.models.oSearch = { bCaseInsensitive: !0, sSearch: "", bRegex: !1, bSmart: !0 }),
        (Ua.models.oRow = { nTr: null, anCells: null, _aData: [], _aSortData: null, _aFilterData: null, _sFilterRow: null, _sRowStripe: "", src: null, idx: -1 }),
        (Ua.models.oColumn = {
            idx: null,
            aDataSort: null,
            asSorting: null,
        ...
        a.extend(Qa, { afnFiltering: Qa.search, aTypes: Qa.type.detect, ofnSearch: Qa.type.search, oSort: Qa.type.order, afnSortData: Qa.order, aoFeatures: Qa.feature, oApi: Qa.internal, oStdClasses: Qa.classes, oPagination: Qa.pager }),
            ...
            header: {
                ...
                jqueryui: function (b, c, d, e) {
                    a("<div/>")
                        ...
                        .append(c.contents())
                        .append(a("<span/>").addClass(e.sSortIcon + " " + d.sSortingClassJUI))
                        .appendTo(c),
                        a(b.nTable).on("order.dt.DT", function (a, f, g, h) {
                            b === f &&
                                ((a = d.idx),
                                    ...
                                    c
                                        ...
                                        .addClass("asc" == h[a] ? e.sSortJUIAsc : "desc" == h[a] ? e.sSortJUIDesc : d.sSortingClassJUI));
                        });
                },
            },
        });
            ...
            number: function (a, b, c, d, e) {
                return {
                    display: function (f) {
                        ...
                        return isNaN(h)
                            ? Fb(f)
                            : ((h = h.toFixed(c)), (f = Math.abs(h)), (h = parseInt(f, 10)), (f = c ? b + (f - h).toFixed(c).substring(2) : ""), g + (d || "") + h.toString().replace(/\B(?=(\d{3})+(?!\d))/g, a) + f + (e || ""));
                    },
                };
            },
            text: function () {
    ...
    (function (a) {
        ...
        return (
            a.extend(!0, e.defaults, { dom: "<'row'<'col-sm-12 col-md-6'l><'col-sm-12 col-md-6'f>><'row'<'col-sm-12'tr>><'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7'p>>", renderer: "bootstrap" }),
            ...
            (e.ext.renderer.pageButton.bootstrap = function (b, f, g, h, i, j) {
                    ...
                    s = function (c, d) {
                        ...
                        for (e = 0, f = d.length; e < f; e++)
                            if (((m = d[e]), a.isArray(m))) s(c, m);
                                ...
                                k &&
                                    ((h = a("<li>", { class: o.sPageButton + " " + l, id: 0 === g && "string" == typeof m ? b.sTableId + "_" + m : null })
                                        .append(a("<a>", { href: "#", "aria-controls": b.sTableId, "aria-label": q[m], "data-dt-idx": r, tabindex: b.iTabIndex, class: "page-link" }).html(k))
                                        .appendTo(c)),
                ...
                s(a(f).empty().html('<ul class="pagination"/>').children("ul"), h),
                    m !== d &&
                    a(f)
                        .find("[data-dt-idx=" + m + "]")
                        .focus();
